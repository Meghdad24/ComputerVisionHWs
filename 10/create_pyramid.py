...
psize = 4 # size of the pyramid (no. of levels)
...
cv2.line(I, (0,0), (0,m-1), (0,0,255),4)
cv2.line(I, (0,0), (n-1,0), (0,0,255),4)
cv2.line(I, (n-1,m-1), (0,m-1), (0,0,255),4)
cv2.line(I, (n-1,m-1), (n-1,0), (0,0,255),4)
